...
<style>
    ...
    /* ================================ BUTTONS================================ */
    :global(.filled--primary) {
        @apply mr-2 bg-teal-500 rounded-md text-white font-semibold px-3 py-2 capitalize hover:bg-teal-600 transition-colors focus:outline-none focus:ring focus:ring-teal-100 disabled:bg-gray-200;
    }
    :global(.no-bg--primary) {
